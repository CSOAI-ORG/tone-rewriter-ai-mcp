<!-- mcp-name: io.github.CSOAI-ORG/tone-rewriter-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/tone-rewriter-ai-mcp.html)
...
[![PyPI](https://img.shields.io/pypi/v/tone-rewriter-ai-mcp)](https://pypi.org/project/tone-rewriter-ai-mcp/) [![Python](https://img.shields.io/pypi/pyversions/tone-rewriter-ai-mcp)](https://pypi.org/project/tone-rewriter-ai-mcp/)
...
```json
{
  "mcpServers": {
    "tone-rewriter-ai-mcp": {
      "command": "uvx",
      "args": ["tone-rewriter-ai-mcp"]
    }
  }
}
```

Or: `pip install tone-rewriter-ai-mcp` then run the `tone-rewriter-ai-mcp` command (stdio transport).
